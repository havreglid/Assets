...
/*                                                                                              */
/************************************************************************************************/
	szTempBuffer.Format(L"%S", "Unofficial Patch 1.70");
	szBuffer.append(szTempBuffer);
/************************************************************************************************/
/* UNOFFICIAL_PATCH                       END                                                   */
/************************************************************************************************/
...
/************************************************************************************************/
	// Add string showing version number
	szTempBuffer.Format(NEWLINE SETCOLR L"%S" ENDCOLR, TEXT_COLOR("COLOR_POSITIVE_TEXT"), "Better BAT AI 2.01 [Build 42]");
	szBuffer.append(szTempBuffer);
#ifdef LOG_AI
...
#ifdef _MOD_SPYNC
	szBuffer.append(szTempBuffer);
	szBuffer.append(gDLL->getText("TXT_KEY_MOD_SPYNC"));
#endif
