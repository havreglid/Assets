...
// New BAT Alternate art enums

enum AltArtTriggerTypes
{
	ART_TRIGGER_NONE = -1,

	ART_TRIGGER_CIVIC,	// Alternate art triggered on a specific civic
	ART_TRIGGER_DEAL,	// Alternate art triggered on a specific deal condition
	ART_TRIGGER_WAR,	// Alternate art triggered on a war condition
	ART_TRIGGER_EVENT,	// Alternate art triggered on a specific event
	ART_TRIGGER_EVENT_RANDOM,	// Alternate art triggered on a random event
	ART_TRIGGER_TECH,	// Alternate art triggered by a technology
