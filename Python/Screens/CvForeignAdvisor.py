...
## Platy Foreign Start ##
	def drawLegend(self, bRedraw):
		...
		# legend
		iButtonSize = 16
		ButtonArt = ArtFileMgr.getInterfaceArtInfo("WORLDBUILDER_TOGGLE_UNIT_EDIT_MODE").getPath()
		ButtonBorder = ArtFileMgr.getInterfaceArtInfo("INTERFACE_BUTTONS_RED_X").getPath()
